...
void CommPlotProducer::Init(TChain *tree)
{
   ...
   if (fChain->GetBranch("mcweight")) { // not stored in Data
   ...
   if (fChain->GetBranch("ncQuarks")) {  // not used anymore
...
//   fChain->SetBranchAddress("SV_vtxDistJetAxis", SV_vtxDistJetAxis, &b_SV_vtxDistJetAxis);
   ...
   if (fChain->GetBranch("TagVarCSV_vertexCategory")) produceTagVarCSVTree = true;
   ...
   if (fChain->GetBranch("TagVarCSV_jetNTracks")) {
   ...
   fChain->SetBranchAddress("DeepFlavourInput_charged_Sip3dVal", DeepFlavourInput_charged_Sip3dVal, &b_DeepFlavourInput_charged_Sip3dVal);
   fChain->SetBranchAddress("DeepFlavourInput_charged_Sip3dSig", DeepFlavourInput_charged_Sip3dSig, &b_DeepFlavourInput_charged_Sip3dSig);
   fChain->SetBranchAddress("DeepFlavourInput_charged_quality", DeepFlavourInput_charged_quality, &b_DeepFlavourInput_charged_quality);
   fChain->SetBranchAddress("DeepFlavourInput_charged_chi2", DeepFlavourInput_charged_chi2, &b_DeepFlavourInput_charged_chi2);
   fChain->SetBranchAddress("DeepFlavourInput_neutral_drminsv", DeepFlavourInput_neutral_drminsv, &b_DeepFlavourInput_neutral_drminsv);
   fChain->SetBranchAddress("DeepFlavourInput_neutral_hadFrac", DeepFlavourInput_neutral_hadFrac, &b_DeepFlavourInput_neutral_hadFrac);
   fChain->SetBranchAddress("DeepFlavourInput_neutral_ptrel  ", DeepFlavourInput_neutral_ptrel  , &b_DeepFlavourInput_neutral_ptrel  );
   fChain->SetBranchAddress("DeepFlavourInput_sv_d3d", DeepFlavourInput_sv_d3d, &b_DeepFlavourInput_sv_d3d);
   fChain->SetBranchAddress("DeepFlavourInput_sv_d3dsig", DeepFlavourInput_sv_d3dsig, &b_DeepFlavourInput_sv_d3dsig);
   fChain->SetBranchAddress("DeepFlavourInput_sv_normchi2", DeepFlavourInput_sv_normchi2, &b_DeepFlavourInput_sv_normchi2);
...
void CommPlotProducer::SetPersonalConfig( bool trackloop, bool svloop, bool tagvarloop, bool tagvarcsvloop) {
   produceJetProbaTree = trackloop;
   produceSVinfo = svloop;
   produceTagVarTree = tagvarloop;
   produceTagVarCSVTree = tagvarcsvloop;
}
